    ...
    return (
        <section className="flex flex-col lg:flex-row gap-10 lg:items-start xl:items-center animate-fade-up reveal" id="about">
            <div className="w-full h-auto ">
                <img src="./hero.webp" className="rounded-xl" alt={t("hero.title")} loading="lazy" />
            </div>
            <div className="flex flex-col gap-6 w-full">
                ...
                <div className="flex justify-between animate-fade-up-800">
                    ...
                    <span className="flex items-center gap-2 px-2 md:px-4 border-b font-medium ">
                        <img src="download.webp" width={34} alt="" aria-hidden="true" />
